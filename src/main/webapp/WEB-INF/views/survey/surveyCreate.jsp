...
<body>
	...
	<nav class="navbar navbar-default"> <!-- 네비게이션 -->
		<div class="navbar-header"> 	<!-- 네비게이션 상단 부분 -->
			...
			<a class="navbar-brand" href="main.jsp">Hitrip</a>
		</div>
		<!-- 게시판 제목 이름 옆에 나타나는 메뉴 영역 -->
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="main.jsp">메인</a></li>
				<li class="active"><a href="itinerary.jsp">여행일정 게시판</a></li>
			</ul>
			<%
		...
		<div class="row">
			<form method="post" action="itineraryCreateAction">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">새 설문지 생성 양식</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="설문지 질문" name="survey_question" maxlength="50"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="설문지 선택지" name="survey_choices" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
				<!-- 글쓰기 버튼 생성 -->
