...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="itineraryUpdate2">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">여행일정 게시판 수정</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="itinerary_title" maxlength="50" value="${itinerary.itinerary_title}"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="itinerary_detail" maxlength="2048" style="height: 350px;">${itinerary.itinerary_details}</textarea></td>
						</tr>
					</tbody>
				</table>
				<!-- 글쓰기 버튼 생성 -->
